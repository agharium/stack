export const ERRORS = {
  ...
  nicknameLength: "O nome deve ter entre 2 e 50 caracteres.",
  nicknameRequired: "Informe seu nome para entrar como convidado.",
  alreadyInRoom: "Você já está nesta sala em outra sessão.",
